                                                ...
                                                <td className="px-6 py-4 whitespace-no-wrap text-center border-b border-gray-200 text-sm leading-5 font-medium">
                                                    <div className="flex justify-center items-center">
                                                        <button
                                                            ...
                                                            className="block  bg-red-500 hover:bg-red-400 text-white border-2 border-red-500 hover:border-red-400 px-3 py-2 rounded uppercase font-poppins font-medium"
                                                        >
                                                            Cancel
                                                        </button>
                                                    </div>
