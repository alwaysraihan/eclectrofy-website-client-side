...
const AddProduct = () => {
    ...
    return (
        <>
            <div className=" my-5 px-4  lg:px-5 text-charcoal min-h-screen font-sans leading-normal overflow-x-hidden lg:overflow-auto">
                <div className="flex-1 md:p-0 lg:pt-8 lg:pb-8 lg:px-8 mx-auto flex flex-col">
